 ...
 */
package ryerson.ca.searchscheduledoctor.endpoint;
...
import ryerson.ca.searchscheduledoctor.business.SearchScheduleDoctor;
...
public class SearchResource {
    ...
    public String getXml(@PathParam("query") String query) {
        SearchScheduleDoctor search= new SearchScheduleDoctor();
        ScheduleWorkXML scheduleWorks = search.getScheduleDoctorsByQuery(query);
        System.out.println(">>>>>>>>>>>>>>>>>>" + scheduleWorks);
...
StringWriter sw = new StringWriter();
    jaxbMarshaller.marshal(scheduleWorks, sw);
