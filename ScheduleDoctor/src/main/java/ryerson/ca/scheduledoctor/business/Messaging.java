...
import ryerson.ca.scheduledoctor.endpoint.MyAppServletContextListener;
import ryerson.ca.scheduledoctor.persistence.ScheduleWork_Login_CRUD;
                    ...
                    if(msgParts.length==3){
                        if(msgParts[0].equals("LOGIN")){
                          ...
                          String date=msgParts[2];
                            ScheduleWork_Login_CRUD.addUsername(username, date);
                        }
                    }
