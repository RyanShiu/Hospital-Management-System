    ...
    <body>
        ...
        <div style="padding-left:16px">
            ...
            <form action="FrontEnd" method="POST"> 
                <button type="submit" name="pageName" value="scheduleWorkPage">Schedule Work</button>
                <button type="submit" name="pageName" value="deletePatientPage">Delete Patient</button>
            </form>
